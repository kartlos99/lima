    ...
    <div class="row">
        ...
        <div class="col-md-2 mb-3">
            <div>
                ...
                <p><input type="text" class="form-control" id="email" placeholder="" name="email" required> @</p>
            </div>
        </div>
    ...
    <div id="block2">
        ...
        <div class="row">
            ...
            <div class="col-lg-2">
                ...
                <input type="text" id="country" class="form-control" placeholder="ქვეყანა" name="country"
                       value="საქართველო">
            </div>
