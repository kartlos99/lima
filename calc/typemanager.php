...
if (!isset($_SESSION['permissionM2']['submod23'])) {
...
?>
    ...
    <div id="section3">
        ...
        <table id="criteriasTable" class="table table-section">
            <thead>
            <tr>
                <?= headerRow(["ID", "მახასიათებელი ჯგუფი", "მახასიათებელი კრიტერიუმი", "სტატუსი", "შენიშვნა", "თარიღი", "მომხმარებელი"], 0, 1) ?>
            </tr>
            </thead>
