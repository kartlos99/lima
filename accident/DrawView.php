...
class DrawView
{
    ...
    static function selector($id = "", $title = "", $name = "", $options = [], $required = "", $form = null)
    {
        $cssClass = "";
        $all_comp = "";
        $id = $name . "_" . $id;
        ...
        if ($title != ""){
            $all_comp = '<label class="'. $required.'" for="' . $id . '">' . $title . '</label>';
            $cssClass = "form-control";
        }
        $all_comp .= '<select class="'. $cssClass.'" id="' . $id . '" name="' . $name . '" '. $form_attr . ' ' . $required . '> '. self::formingOption($options) .' </select>';
        return $all_comp;
    }
...
//        <input type="' . $type . '" class="form-control" id="' . $id . '" placeholder="" name="' . $name . '" data-field="'. $dataField .'" '. $form_attr .'/>';
    ...
    static function simpleInput($id = "", $name, $title, $dataField = "", $type = "text", $required = "", $form = null)
    {
        $id = $name . "_" . $id;
        $form_attr = $form == null ? "" : "form=\"$form\"";
        $view = '
        <label class="'. $required.'" for="' . $id . '">' . $title . '</label>
        <input type="' . $type . '" class="form-control" id="' . $id . '" placeholder="" name="' . $name . '" data-field="'. $dataField .'" '. $form_attr .' ' . $required . '/>';
        return $view;
    }
